...
def connect(receiver, signal=Any, sender=Any, weak=True, expiry=-1):
...
def send(signal=Any, sender=Anonymous, *arguments, **named):
    ...
    for receiver in removals:
        disconnect(receiver,receiver.signal,receiver.sender,receiver.weak)
    return responses
